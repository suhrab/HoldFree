...
<div id="sidebar">
    <div class="mainNav">
        ...
        <ul class="nav">
            ...
            <li><a href="/?module=user&dashboard=1" title="Пользователи" {if $smarty.get.module == 'user'}class="active"{/if}><img src="{$_dashboard}/images/icons/mainnav/ui.png" alt="" /><span>Пользователи</span></a>
                <ul>
            ...
            <li><a href="/index.php?module=option&dashboard=1" title=""><img src="{$_dashboard}/images/icons/mainnav/forms.png" alt="" /><span>Настройки</span></a>
                <ul>
            ...
            <li><a href="tables.html" title=""><img src="{$_dashboard}/images/icons/mainnav/tables.png" alt="" /><span>Tables</span></a>
                <ul>
            ...
            <li><a href="other_calendar.html" title=""><img src="{$_dashboard}/images/icons/mainnav/other.png" alt="" /><span>Other pages</span></a>
                <ul>
