            ...
            <fieldset>
                <div class="widget">
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9"><input type="text" class="required" name="question" value="{$faq_data.question}"></div><div class="clear"></div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid3"><label>Ответ:<span class="req">*</span></label></div>
                        <div class="grid9"><textarea rows="8" cols="" name="answer" class="auto" class="required">{$faq_data.answer}</textarea></div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow"><input type="submit" value="Сохранить" class="buttonM bBlue formSubmit"><div class="clear"></div></div>
                    <div class="clear"></div>
