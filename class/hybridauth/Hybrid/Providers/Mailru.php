...
class Hybrid_Providers_Mailru extends Hybrid_Provider_Model_OAuth2
{
    ...
    function getUserProfile()
    {
        $params = array(
            ...
            'session_key' => $this->api->access_token . $this->api->client_secret
        );
        $sig = sign_server_server($params, $this->api->client_secret);
        ...
        $final_request = "/?format=json&app_id=" . $this->api->client_id . "&method=users.getInfo&secure=1&sig=" .$sig;
        $response = $this->api->api($final_request);
