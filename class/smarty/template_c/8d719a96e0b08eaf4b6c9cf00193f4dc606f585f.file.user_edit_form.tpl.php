<?php /* Smarty version Smarty-3.1.13, created on 2013-07-22 14:13:25
         compiled from "/Users/Gee/Sites/Holdfree/template/default/_dashboard/user_edit_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:160073325151e1fdea96a0e7-86829726%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8d719a96e0b08eaf4b6c9cf00193f4dc606f585f' => 
    array (
      0 => '/Users/Gee/Sites/Holdfree/template/default/_dashboard/user_edit_form.tpl',
      1 => 1373853352,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '160073325151e1fdea96a0e7-86829726',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_51e1fdeac82b07_19290259',
  'variables' => 
  array (
    'meta_title' => 0,
    '_dashboard' => 0,
...
<?php if ($_valid && !is_callable('content_51e1fdeac82b07_19290259')) {function content_51e1fdeac82b07_19290259($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
/images/icons/quickstats/money.png" alt="" /></a>
    ...
    <div class="breadLine">
        <div class="bc">
            ...
            <li><a href="/?module=dashboard&dashboard=1">Панель управления</a></li><li><a href="/?module=user&dashboard=1">Пользователи</a></li><li class="current"><a href="#">Редактирование</a></li>
            </ul>
        </div>
            ...
            <fieldset>
                <div class="widget">
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9"><input type="text" class="required" name="first_name" id="first_name" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['first_name'];?>
"></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid3"><label>Фамилия пользователя:</label></div>
                        <div class="grid9"><input type="text" name="last_name" id="last_name" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['last_name'];?>
"></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid3"><label>Email пользователя:<span class="req">*</span></label></div>
                        <div class="grid9"><input type="text" class="required" name="email" id="email" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['email'];?>
"></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
...
" <?php if ($_smarty_tpl->tpl_vars['user']->value['country']==$_smarty_tpl->tpl_vars['country']->value['id']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['country']->value['name'];?>
</option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9">
                            <select name="group" id="group" class="required">
                                <option value="0" <?php if ($_smarty_tpl->tpl_vars['user']->value['group']==0){?>selected="selected"<?php }?>>Пользователи</option>
                                <option value="1" <?php if ($_smarty_tpl->tpl_vars['user']->value['group']==1){?>selected="selected"<?php }?>>Администраторы</option>
                            </select>
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9 on_off">
                            <div class="floatL mr10"><input type="checkbox" id="ban" name="ban" <?php if ($_smarty_tpl->tpl_vars['user']->value['ban']){?>checked="checked"<?php }?> /></div>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid3"><label>Дата окончания бана:</label></div>
                        <div class="grid9"><input type="text" class="datepicker" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['ban_end'];?>
" name="ban_end" /></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid3"><label>Причина бана:</label></div>
                        <div class="grid9"><input type="text" name="ban_reason" id="reason" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['ban_reason'];?>
"></div><div class="clear"></div>
                    </div>
